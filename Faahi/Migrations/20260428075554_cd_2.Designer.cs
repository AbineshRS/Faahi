...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faahi.Model.am_vcos.ar_Customers", b =>
                {
                    ...
                    b.Property<Guid?>("customer_due_id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Faahi.Model.am_vcos.ar_customer_due", b =>
                {
                    b.Property<Guid>("customer_due_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("customer_due_id", "business_id")
                        .HasDatabaseName("IX_ar_customer_due");

                    b.ToTable("ar_customer_due");
                });
            ...
            modelBuilder.Entity("Faahi.Model.am_vcos.ar_Customers", b =>
                {
                    b.HasOne("Faahi.Model.am_vcos.ar_customer_due", "ar_Customer_Due")
                        .WithMany()
                        .HasForeignKey("customer_due_id");

                    b.HasOne("Faahi.Model.Shared_tables.st_Parties", null)
                        .WithMany("ar_Customers")
                        .HasForeignKey("st_Partiesparty_id");

                    b.Navigation("ar_Customer_Due");
                });
