...
namespace Faahi.Migrations
{
    ...
    [Migration("20260307075221_createaccountTemplate")]
    partial class createaccountTemplate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Faahi.Model.Accounts.gl_AccountMapping", b =>
                {
                    ...
                    b.HasIndex(new[] { "CompanyId", "StoreId", "Module", "PurposeCode" }, "UQ_gl_AccountDefaults_CompanyPurpose")
                        .IsUnique()
            ...
            modelBuilder.Entity("Faahi.Model.Accounts.gl_AccountTemp", b =>
                {
                    b.Property<Guid>("GlAccountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Faahi.Model.Accounts.gl_JournalLines", b =>
                {
                    ...
                    b.HasIndex(new[] { "BusinessId", "AccountId" }, "IX_gl_JournalLines_Account");

                    b.HasIndex(new[] { "JournalId", "LineNo" }, "IX_gl_JournalLines_Journal");

                    b.HasIndex(new[] { "BusinessId", "StoreId", "AccountId" }, "IX_gl_JournalLines_StoreAccount");
            ...
            modelBuilder.Entity("Faahi.Model.Accounts.gl_Ledger", b =>
                {
                    ...
                    b.HasIndex(new[] { "CompanyId", "PostingDate", "GlAccountId" }, "IX_gl_Ledger_CompanyDateAccount");

                    b.HasIndex(new[] { "CompanyId", "TransactionDate" }, "IX_gl_Ledger_CompanyTransactionDate");

                    b.HasIndex(new[] { "JournalId", "JournalLineId" }, "IX_gl_Ledger_JournalRefs");

                    b.HasIndex(new[] { "Module", "PostingDate" }, "IX_gl_Ledger_ModuleDate");

                    b.HasIndex(new[] { "Module", "SourceId" }, "IX_gl_Ledger_Source");
