...
{
    public class im_purchase_listing_dto
    {
        [Key]
        ...
        public ICollection<im_purchase_listing_details_dto>? im_purchase_listing_details { get; set; } = null;

        public ICollection<temp_im_purchase_listing_details_dto>? temp_Im_Purchase_Listing_Details { get; set; } = null;
    }
}
